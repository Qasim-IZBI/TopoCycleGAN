#!/bin/bash
#SBATCH --job-name=topo_pr
#SBATCH --output=logs_topo/pr_%A_%a.out
#SBATCH --error=logs_topo/pr_%A_%a.err
...
#
#   sbatch slurm/sweep_pr.sh                          # all 27
#   sbatch --array=0-8,10-17,19-26 slurm/sweep_pr.sh  # skip duplicate baselines
